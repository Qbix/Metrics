 ...
 * Instead, change the Metrics/TrackerTrait.js file.
 *
 * @module Metrics
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Metrics', 'indexes', 'TrackerTrait'], false)) {
		return new Db.Expression((withoutDbName ? '' : '{{dbname}}.')+'{{prefix}}tracker_trait');
	} else {
		var conn = Db.getConnection('Metrics');
		var prefix = conn.prefix || '';
		var tableName = prefix + 'tracker_trait';
 ...
 * @type string
 */
Base.prototype.className = "Metrics_TrackerTrait";
...
Base.prototype.beforeSave = function (value) {
	var fields = ['trackerId','traitId'], i;
	if (!this._retrieved) {
	...
	if (this.fields["traitId"] == undefined && value["traitId"] == undefined) {
		this.fields["traitId"] = value["traitId"] = "";
	}
	return value;
};
